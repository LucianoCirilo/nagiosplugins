...
# Based on the following plugin with the aditional ciscoSW, extremeSW and juniper options and support for IPv6
############################## check_snmp_env #################
# Version : 1.3
# Date : Jun 20 2007
...
sub print_usage {
    print "Usage: $0 [-v] [-6] -H <host> -C <snmp_community> [-2] | (-l login -x passwd [-X pass -L <authp>,<privp>])  [-p <port>] -T (cisco|nokia|bc|iron|foundry|linux|ciscoSW|extremeSW|juniper) [-F <rpm>] [-c <celcius>] [-f] [-t <timeout>] [-V]\n";
}
...
-T, --type=cisco|nokia|bc|iron|foundry|linux|ciscoSW|extremeSW|juniper
...
Notes:
Check the http://www.nagiosexchange.org website for new versions.
...
########### Cisco card and module status checks ##############
